    ...
    decryptBtn.addEventListener('click', function() {
        ...
        setTimeout(() => {
            ...
            if (userInput.toLowerCase() === correctEncrypted.toLowerCase() || 
                ...
                result.textContent = "สุขสันต์วันครบรอบ 2 ปีนะที่รักก 💖ขอบคุณที่อยู่ข้างกันมาตลอดนะคะ ขอบคุณที่เป็นรอยยิ้มให้เค้า เป็นกำลังใจ และเป็นคนสำคัญของกันเสมอตลอด 2 ปีที่ผ่านมา เราทั้งคู่อาจมีทั้งรอยยิ้ม น้ำตา ความไม่เข้าใจ และบทเรียนมากมายแต่ทุกวินาทีที่มีกัน มันคือของขวัญล้ำค่าที่สุดเลยนะขอให้เรารักกันไปนานๆนะครับ เติบโตไปด้วยกัน และจับมือกันแน่นๆ อยากมีครอบครัวกับบี๋นะคุณพยาบาลคนสวยยยย รักน้าาาาาาาาา อุอิ 💕";
